...
class Application extends Helper {
    // vars {
        ...
        private $__control_file_dirpath = '../../../private';
        ...
        // public {
            ...
            public function init(){
                ...
                try {
                    ...
                    throw new \core\classes\controller\ControllerException(Error::get('app_registry'), 0, $ex);
                }
                ...
                try {
                    ...
                    \ApplicationRegistry::setControllerMap($this->__map);
                ...
                try {
                    ...
                    \ApplicationRegistry::setCurrentUser($user);
