...
$inserts = array(
    ...
    'insert_user_plain1'         => "INSERT INTO user(email, password, firstname, lastname, user_role_id, sex, cdate, bdate, isactive, token) VALUES('tolkien@gmail.com', '".\core\functions\password('password')."', 'John Ronald Reuel', 'Tolkien', 1, 'M', '".date(\DATETIME)."', '1984-01-03', 1, '". \core\functions\token('johnronaldreueltolkienpassword')."')",
    'insert_user_plain2'         => "INSERT INTO user(email, password, firstname, lastname, user_role_id, sex, cdate, bdate, isactive, token) VALUES('gollum@gmail.com', '".\core\functions\password('password')."', 'Gollum', 'Smeagol', 1, 'M', '".date(\DATETIME)."', '1987-06-16', 1, '". \core\functions\token('gollumsmeagolpassword')."')",
    'insert_user_plain3'         => "INSERT INTO user(email, password, firstname, lastname, user_role_id, sex, cdate, bdate, isactive, token) VALUES('einstein@gmail.com', '".\core\functions\password('password')."', 'Albert', 'Einstein', 1, 'M', '".date(\DATETIME)."', '1879-03-14', 1, '". \core\functions\token('alberteinsteinpassword')."')",
