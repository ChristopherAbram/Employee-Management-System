...
<div class="tile">
    <div class="imgContener">
        <div class="cross">
            ...
            <input form="avatar" type="radio" name="file[]" value="{$image.id}" checked="checked">
        </div>
...
<form id="avatar" class="uploadForm" action="{$panel.link}/userimage" method="post" enctype="multipart/form-data">
